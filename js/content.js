...
const SCC_CONTENT = {
  ...
  resources: {
    ...
    mentors: [
      // TODO: replace with real mentors' details, or remove entries.
      { name: "Add a mentor name", role: "e.g. Alumni, Data Analyst", contact: "email or LinkedIn link" },
    ],
  },
  ...
  /* ---------------------------------------------------------
     ...
     --------------------------------------------------------- */
  team: [
    { name: "Add name", role: "President", bio: "Chief executive of SCC; presides over meetings and represents the club officially.", photo: "" },
    { name: "Add name", role: "Vice Chairperson", bio: "Supports the President and steps in on their behalf when needed.", photo: "" },
    { name: "Add name", role: "Speaker", bio: "Presides over club events and chairs the Electoral Committee.", photo: "" },
    { name: "Add name", role: "General Secretary", bio: "Keeps minutes, correspondence, and the membership register.", photo: "" },
    { name: "Add name", role: "Minister of Finance", bio: "Safeguards funds and presents audited accounts at the AGM.", photo: "" },
    { name: "Add name", role: "Projects Manager", bio: "Leads planning and execution of SCC projects and collaborations.", photo: "" },
    { name: "Add name", role: "Public Relations & Social Media Officer", bio: "Publicises events and manages SCC's digital presence.", photo: "" },
    { name: "Add name", role: "Legal Advisor", bio: "Chairs the Legal Advisory Committee and ensures constitutional compliance.", photo: "" },
  ],
